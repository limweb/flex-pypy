...
#from pypy.translator.flex.test.runtest import compile_function
...
js_optiondescr = OptionDescription("jscompile", "", [
    ...
    StrOption("output", "File to save results (default output.mxml)",
              default="output.mxml", cmdline="--output")])
...
from pypy.translator.flex.helper import __show_traceback
...
def rpython2javascript(mod, function_names, jsconfig=None, use_pdb=False):
